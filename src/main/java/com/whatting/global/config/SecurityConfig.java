    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/alerts/{alertId}/dashboard").hasAuthority("TEACHER")
                        .requestMatchers(HttpMethod.GET, "/api/v1/alerts/{alertId}/result").hasAuthority("TEACHER")
